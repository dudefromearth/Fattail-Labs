...
| **Surface T Ortho** | Spec **v0.1 DRAFT** `FatTail-Labs-Options-Lab-Surface-T-Ortho-Spec-v0.1.md` (**OL-TO** · **DL-476**) — S×t IV contour · squawk observation-only · no Phase 5 yet |
