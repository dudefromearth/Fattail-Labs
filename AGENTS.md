...
| **Heatmap gex-cal (GBH instance · DL-747 · HM / OD-GC)** | Third build instance. Board `agents/p-options-lab-heatmap-gex-calendar/`. Spec **DRAFT** `FatTail-Labs-Options-Lab-Heatmap-GEX-Calendar-Spec-v0_1.md` sha1 `36a347185aaece5c4b900bf22e9683ad4ffbaf6f` until **OD-GC1…GC4**. Data: frozen `gex_v1` generations. **Not** VP stores/surfaces. **Not** the VP heatmap overlay (SA-edges). Separate Labs routes (heatmap vs volume-profile). Collectors win. Conflicts through Coach. |
