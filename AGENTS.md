...
| **Options Lab Surface Autofit** | Spec **v0.1** `FatTail-Labs-Options-Lab-Surface-Autofit-Spec-v0.1.md` · **DL-421** — default window = furthest of BEs and listed Ks + spot inside + equal pad; special cases amend as **AF-n** |
