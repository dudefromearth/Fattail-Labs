...
| **VP data end (INFRA instance · DL-720 · VPS / VPSB)** | **Singular drive (DL-727):** 1 download → 2 bins → 3 API. Contract v1.0 frozen (**DL-726** sha1 `b403937a…`; parent **v0.6.1 landed** **DL-730**). VP **v0.6.1** `7e3bbedc…` · SA **v0.3.1** `8298b572…` · **AZ-VP-9-A1** `53bf74da…` **MATCH**. SA v0.4 file = **DIRECTIVE POINTER** (**DL-728**), not BUILD. Composite fenced. Tonight: VPS1-G → VPS2 ACT 3 (GO only) → VPSB ACT B → backfill tranche 1. Board `agents/p-volume-profile-service/`. **CP-1**. **APPS** `SADEV*` READ-ONLY. **ADVISOR** reviews. |
