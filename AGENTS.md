...
| **Options Lab Heatmap · LIM** | Spec **v0.4.5 BUILD AUTHORITY** `FatTail Labs — Heatmap LIM Template — Specification v0.4.5.md` (E1–E25 · E26 withdrawn · **DL-657** D3/D4) · v0.4.4 SUPERSEDED · parent Templates **v0.2.4** · board `agents/p-options-lab-heatmap-lim/` · token `agents/go/OLLIM-W0.md`. Member guide `docs/Options-Lab-Heatmap-LIM-User-Guide.md` · help `server/help_reference/options-lab-heatmap-lim.md`. No volume; registry `lim` only |
