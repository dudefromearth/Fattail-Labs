...
| `/apply` | Native fattail conversation invite — intro, email, Heaven before Hell (**DL-453**). One question at a time, two motion beats, eyes stay put (**DL-452**). Writes Cole’s seven AC fields + tag 18. **DL-451**. |
