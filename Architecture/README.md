...
| Spec **Analyzer Algo Alert v1.0.16** | `Specs/FatTail-Labs-Options-Lab-Analyzer-Algo-Alert-Spec-v1.0.md` — OTM-fly trail · floor default **25** (knobs are law) · Recorded `mode` · add fly after Time Machine day (**ALGO-TM1**) · no narrative on the Algo panel (**ALGO-N1**) · Reason checkbox starts basic floater narration; prompt is optional focus (**ALGO-R1** · **DL-510**) · house base prompt in-place on `/app/alerts` (**DL-511**) · High/Profit/Trail/Stop HUD only while Live+Armed (**AT-ALGO-17** · **DL-518**) · TF host `algo-reason` (**DL-514** · **DL-517**) · timestamped post tape; house base = instructions prompt (**DL-515**) · **Trader Feed venue** (**DL-516**) · **AZ-ALGO** · DRAFT · **DL-472** · **DL-473** · **DL-488** · **DL-492** · **DL-495** · **DL-498** · **DL-500** · **DL-513** · bench `docs/Options-Lab-Analyzer-Algo-Alert-Full-Agent-Bench-Plan-v1.0.md` **v1.0.3** · board `agents/p-az-algo/` · **DL-474** · **DL-489** |
