...
| Spec **Analyzer Algo Alert v2.2.1 DRAFT** | `Specs/FatTail-Labs-Options-Lab-Analyzer-Algo-Alert-Spec-v2.2.1.md` — **AZ-ALGO** · sha1 `6f491ee8f240aa06418b8e813fdb3152ed60deb5` · E1–E22 · **DL-661** · v2.0 SUPERSEDED · v2.1/v2.2 never landed · **not BUILD AUTHORITY** (Appendix B goldens + OD-ALGO-1) · board `agents/p-az-algo/` |
