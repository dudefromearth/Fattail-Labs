...
| [29-options-lab-heatmap-templates.md](./29-options-lab-heatmap-templates.md) | **Options Lab Heatmap:** chain template framework (flies, verticals, GEX, Width Fit) over one live model · **HM21** inspector tab-session **DL-575** |
...
| [35-options-lab-volume-profile.md](./35-options-lab-volume-profile.md) | **Options Lab Volume Profile (Visible Range widget):** LWC candlesticks + L2 primitive + `/window` (**AZ-VP-9** · **DL-764** · **DL-765** · **DL-788**) |
| [37-visible-range-volume-profile-api.md](./37-visible-range-volume-profile-api.md) | **Visible Range VP API (as-built):** member hop `vp_display`, computing `/v1/profile/{target}/window`, history OHLC hop, envelope |
...
| Arch **29** | **Heatmap templates** (design + as-built): flies / verticals / GEX / Width Fit over one chain model · diff once · many views · **HM21** inspector tab-session |
...
| Spec **IKI Lab Member Product v0.1** | `Specs/FatTail-Labs-IKI-Lab-Member-Product-Spec-v0_1.md` — plan `iki-lab` · Woo IKI Lab on fattail.ai · Your Lab (Heatmap) · Analyzer (OPF) · **DL-604** · **DL-607** |
...
| Spec **Time Machine v0.7.4 BUILD AUTHORITY** | `Specs/FatTail-Labs-Options-Lab-Time-Machine-Spec-v0_7_4.md` — **DL-598** · TMI-79 two browser slots (today always capturing; at most one archive day) · two blobs, one playhead · no film module · no TM glow · **TMI-97 DRAFT** on §6.2: usability law directed to the scrubber window (landmarks; clock stays; **DL-646**; not BUILD) · plan **v1.2** `docs/Options-Lab-Time-Machine-Full-Agent-Bench-Plan-v1.2.md` · board `agents/p-options-lab-tm/` · token `agents/go/TM-W0.md` **W0–W9 + W-G PASS** (**DL-609** · **DL-610** KEEP extras · **DL-611**) · listed tent walked on Surface · HOLD: Basic / TPO / 1× / Instant Replay film / Record · leftover boards PARKED |
| Spec **StudioOne Archive Read v0.8 + A1 + Amendment A2_1** | `Specs/FatTail-Labs-StudioOne-Archive-Read-API-Spec-v0_8.md` + A1 + **A2_1** — marks tape + 2026-08-14 SPY + symbol-completeness + **15 s GAP floor** + **`VIX NOT NATIVE`**. Plan **v1.0** `docs/StudioOne-Archive-Read-API-Amendment-A2-Full-Agent-Bench-Plan-v1.0.md`. Token `agents/go/SOAR-A2-W0.md` **W0-0 STAMP · W0-BA GO 2026-08-29**. Board `agents/p-studioone-archive-read/` A2 strip. **A2 W-G PASS 2026-08-29.** Bearer on. Stats first backfill 14 days. Nightly 02:00 launchd **`Background`** (`user/503`). One carry: **AT-SOAR-45** Monday. Parent v2.1 GO is not this program. |
| Spec **TM Scrubber Landmarks DRAFT v0.1** | `Specs/DRAFT-FatTail-Labs-Options-Lab-Time-Machine-Scrubber-Landmarks-Spec-v0_1.md` — **usability law directed to the scrubber window** (TMI-97 DRAFT on parent TM §6.2). Clock stays. **DL-645 · DL-646**. Not BUILD. Not calendar / AV-*. |
| Spec **Archive Availability DRAFT v0.2** | `Specs/DRAFT-FatTail-Labs-Archive-Availability-and-Calendar-Honesty-Spec-v0_2.md` — AV-9/10/11 law; AV-12 hole named (08-14/08-17). Plan **v1.0**. Token `AV-W0`. **Not BUILD.** **DL-642**. v0.1 SUPERSEDED. |
| Spec **Time Machine One Source v0.4 BUILD AUTHORITY** | `Specs/FatTail-Labs-Options-Lab-Time-Machine-One-Source-Spec-v0_4.md` — Coach GO SPEC **2026-08-29**. TMI-91 desk · TMI-92 original feed · TMI-93 named hole · TMI-94 VIX + source travels · TMI-95 read the tape · **TMI-96** dark not hidden. OS-13 = 08-27 proxy. OS-14 = 08-29 native. **W-G PASS.** C11 553 MB ship-and-watch; hold-resident on `/admin/archive`. **§13a item 1 ruled:** dark position, no legs until light. Items 2–3 still Coach. Plan **v1.3**. Token `agents/go/TMOS-W0.md`. |
| Spec **Time Machine One Source v0.3 DRAFT** | `Specs/FatTail-Labs-Options-Lab-Time-Machine-One-Source-Spec-v0_3.md` — **DL-617** · **DL-618** · SUPERSEDED by v0.4 |
| Spec **Time Machine One Source v0.2.1 DRAFT** | `Specs/FatTail-Labs-Options-Lab-Time-Machine-One-Source-Spec-v0_2_1.md` — **DL-616** · SUPERSEDED by v0.4 · plan **v1.2** is against this file — do not stamp as the v0.4 plan · board `agents/p-options-lab-tm-os/` · token `agents/go/TMOS-W0.md` |
| Spec **Analyzer Time Machine v0.1.7** | `Specs/FatTail-Labs-Options-Lab-Analyzer-Time-Machine-Spec-v0.1.md` — **AZ-ATM** · DRAFT · OnDemand **day replay** · **390** candles/closes · close-to-close **or** TPO path · Spot + Autofit X = session **open** (**ATM-O1**) · add fly **after** the day then Algo (**ATM-A1**) · **Reset** exit, What-if chrome (**ATM-S3**) · **DL-486** · **DL-487** · **DL-491** · **DL-492** · **DL-494** · **DL-499** · bench `docs/Options-Lab-Analyzer-Time-Machine-Full-Agent-Bench-Plan-v1.0.md` · board `agents/p-az-atm/` · **DL-489** — **folded into v0.7.3**; board **PARKED** |
| Spec **Analyzer Algo Alert v2.2.2 BUILD AUTHORITY** | `Specs/FatTail-Labs-Options-Lab-Analyzer-Algo-Alert-Spec-v2.2.2.md` — **AZ-ALGO** · sha1 `b757ba3f4b3816fcaebae857aeda70dff488ecdc` · E23 floor formula · E24 at-body PaR tie-break · **DL-664** GO · **DL-662** · **DL-663** · v2.2.1 SUPERSEDED as law (fixtures 1–16 freeze) · **OD-ALGO-1…5 disposed** (Guide · k_base · manual_confirm · percentile · VP overlay out) · token `agents/go/AZALGO-W0.md` **GO** · bench `docs/Options-Lab-Analyzer-Algo-Alert-Full-Agent-Bench-Plan-v2.0.md` **v2.0 GO** · **P0-G PASS** · board `agents/p-az-algo/` |
| Spec **Analyzer Algo Alert v1.0.16** | `Specs/FatTail-Labs-Options-Lab-Analyzer-Algo-Alert-Spec-v1.0.md` — **SUPERSEDED** as product law by v2.0 (**DL-660**). As-built W1–W4: OTM-fly Demo-only trail · floor **25** · **ALGO-N1** · **ALGO-R1** · HUD High/Profit/Trail/Stop · TF host `algo-reason` specified, not mounted · **DL-472** · **DL-473** · **DL-488** · **DL-492** · **DL-495** · **DL-498** · **DL-500** · **DL-513** · **DL-518** · board `agents/p-az-algo/` · **DL-474** · **DL-489** |
| Spec **Surface T Ortho v0.1.10** | `Specs/FatTail-Labs-Options-Lab-Surface-T-Ortho-Spec-v0.1.md` — **OL-TO** · DRAFT · S×t IV contour · What-if cursor not rewritten path (**TO-B1**) · Surface = Analyzer-canvas alternate; T Ortho = Easter Egg (**DL-509**) · tape and box share strike scale (**DL-512**) · TF host `t-ortho` replaces egg narrative box (**DL-514** · **DL-517**) · instructions prompt + timestamped posts (**DL-515**) · **Trader Feed venue** (**DL-516**) · **DL-476** · **DL-478** · **DL-513** |
| Spec **Trader Feed v0.1.3** | `Specs/FatTail-Labs-Trader-Feed-Spec-v0.1.md` — **TF** · DRAFT · formerly Feature Narrative (**FN**) · market + position + trader aware continuous narrative · customized **per venue** · same **base market info** · replaces T Ortho narrative box · supplements Algo Alert · Journal-shaped, generalized · **DL-514** · **DL-515** · **DL-516** · **DL-517** |
| Spec **FatTail Intelligence v0.1.2** | `Specs/FatTail-Labs-FatTail-Intelligence-Spec-v0.1.md` — **FTI** · DRAFT · session-scaled σ (**FTI-B1**) · exit `p_fill` retry · knobs-as-inputs (**DL-488**) · **DL-477** · **DL-478** · **OD-FTI-OPF open** |
| Spec **Surface Autofit v0.1.10** | `Specs/FatTail-Labs-Options-Lab-Surface-Autofit-Spec-v0.1.md` — **ACCEPTED** · default pad **50%** · $0 plane **40%** · Autofit restores both (**DL-506** · **DL-507** · **DL-508**) · AF-L5 structure-signal / fit-if-needed (**PC9a**) · **DL-421** · bench `docs/Options-Lab-Surface-Autofit-Full-Agent-Bench-Plan-v1.0.md` · **DL-422** |
...
| Spec **Heatmap Templates v0.2.1** | `Specs/FatTail-Labs-Options-Lab-Heatmap-Templates-Spec-v0_2.md` — product law (DRAFT); **HM21** inspector tab-session (`sessionStorage` `ft_labs_heatmap_session`) **DL-575**; help `server/help_reference/options-lab-heatmap-session.md` (**DL-576**); v0.1 superseded |
| Spec **Template Runner v0.1.2** | `Specs/FatTail-Labs-Template-Runner-Spec-v0_1.md` — **TR-P1 GO** browser shell `web/lib/runner/` · heatmap registered unchanged · flag `NEXT_PUBLIC_LABS_RUNNER_SHELL` · **DL-533** · **TR14 stream book GO** **DL-574** · token `agents/go/TRSB-W0.md` · plan [`docs/Template-Runner-Stream-Book-Full-Agent-Bench-Plan-v1.0.md`](../docs/Template-Runner-Stream-Book-Full-Agent-Bench-Plan-v1.0.md). **TR13** = IKI-P3 host chrome, not the book. **HM21** inspector blob is not the book (**DL-575**) |
| Bench plan | `docs/Options-Lab-Heatmap-Templates-Full-Agent-Bench-Plan-v1.0.md` · board `agents/p-options-lab-heatmap/` |
| Spec **Heatmap Width Fit v0.1.2 BUILD AUTHORITY** | `Specs/FatTail-Labs-Options-Lab-Heatmap-Width-Fit-Spec-v0_1.md` — **WF** · Heatmap **Template** `width-fit` (**DL-529**) · member criteria weights · neighborhood **penalty** (**OD-W6 Accept**) · honest \(n\) · observation-only · **OD-W1…W6 Accept** · **DL-525** · **§8.5** tab-session inspector **HM21** (**DL-575**) · bench `docs/Options-Lab-Heatmap-Width-Fit-Full-Agent-Bench-Plan-v1.1.md` · board `agents/p-options-lab-heatmap-width-fit/` · W0 `agents/go/OLHWF-W0.md` · member guide [`docs/Options-Lab-Heatmap-Width-Fit-User-Guide.md`](../docs/Options-Lab-Heatmap-Width-Fit-User-Guide.md) · help concierge `server/help_reference/options-lab-heatmap-width-fit.md` (**DL-530**) |
| Spec **Heatmap LIM v0.4.3 BUILD AUTHORITY** | `Specs/FatTail Labs — Heatmap LIM Template — Specification v0.4.3.md` — sha1 `01f638f590492520236b3607edde487b949d6016` · **DL-651** · as-built **DL-653** · parent Templates **v0.2.4** · board `agents/p-options-lab-heatmap-lim/` · member guide [`docs/Options-Lab-Heatmap-LIM-User-Guide.md`](../docs/Options-Lab-Heatmap-LIM-User-Guide.md) · help `server/help_reference/options-lab-heatmap-lim.md` |
