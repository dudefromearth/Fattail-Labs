...
| Decisions | **DL-450** (spec) · **DL-451** (write) · **DL-452** (one-at-a-time · two beats · eyes stay put) · **DL-453** (invite copy · Heaven before Hell) · **DL-454** (accept next to the field · superseded layout by **DL-457**) · **DL-455** (Review before AC submit) · **DL-456** (Review edits in place) · **DL-457** (Back / OK twins under the field) · **DL-458** (thick ink field border) · **DL-459** (selftest excluded from `next build`) · **DL-460** (field 7 calendar invite) · **DL-461** (server-owned slots; no Calendly / free picker) · **DL-462** (server-owned questions + types; four content checks) · **DL-463** (three endings · admin score map · Coach / Lakesia / trial) |
