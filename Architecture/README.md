...
| Spec **Analyzer Algo Alert v2.2.2** | `Specs/FatTail-Labs-Options-Lab-Analyzer-Algo-Alert-Spec-v2.2.2.md` — **AZ-ALGO** · sha1 `b757ba3f4b3816fcaebae857aeda70dff488ecdc` · E23 floor formula · E24 at-body PaR tie-break · **DL-662** · **DL-663** · v2.2.1 SUPERSEDED as law (fixtures 1–16 freeze) · **OD-ALGO-1 DISPOSED: Guide** · **not BUILD AUTHORITY** until token `agents/go/AZALGO-W0.md` GO · bench `docs/Options-Lab-Analyzer-Algo-Alert-Full-Agent-Bench-Plan-v2.0.md` **v2.0 UNSTAMPED** · board `agents/p-az-algo/` |
