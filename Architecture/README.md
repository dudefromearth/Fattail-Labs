...
| Spec **Analyzer Time Machine v0.1.5** | `Specs/FatTail-Labs-Options-Lab-Analyzer-Time-Machine-Spec-v0.1.md` — **AZ-ATM** · DRAFT · OnDemand **day replay** · **390** candles/closes · close-to-close **or** TPO path · Spot + Autofit X = session **open** (**ATM-O1**) · add fly **after** the day then Algo (**ATM-A1**) · **DL-486** · **DL-487** · **DL-491** · **DL-492** · bench `docs/Options-Lab-Analyzer-Time-Machine-Full-Agent-Bench-Plan-v1.0.md` · board `agents/p-az-atm/` · **DL-489** |
| Spec **Analyzer Algo Alert v1.0.3** | `Specs/FatTail-Labs-Options-Lab-Analyzer-Algo-Alert-Spec-v1.0.md` — OTM-fly **narrative trail** · floor default **25** (knobs are law) · Recorded `mode` · add fly after Time Machine day (**ALGO-TM1**) · **AZ-ALGO** · DRAFT · **DL-472** · **DL-473** · **DL-488** · **DL-492** · bench `docs/Options-Lab-Analyzer-Algo-Alert-Full-Agent-Bench-Plan-v1.0.md` **v1.0.3** · board `agents/p-az-algo/` · **DL-474** · **DL-489** |
