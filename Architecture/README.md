...
| Spec **Analyzer Algo Alert v1.0.7** | `Specs/FatTail-Labs-Options-Lab-Analyzer-Algo-Alert-Spec-v1.0.md` — OTM-fly trail · floor default **25** (knobs are law) · Recorded `mode` · add fly after Time Machine day (**ALGO-TM1**) · no narrative on the Algo panel (**ALGO-N1**) · High/Trail/Stop HUD only while Live+Armed (**AT-ALGO-17**) · **AZ-ALGO** · DRAFT · **DL-472** · **DL-473** · **DL-488** · **DL-492** · **DL-495** · **DL-498** · **DL-500** · bench `docs/Options-Lab-Analyzer-Algo-Alert-Full-Agent-Bench-Plan-v1.0.md` **v1.0.3** · board `agents/p-az-algo/` · **DL-474** · **DL-489** |
| Spec **Surface T Ortho v0.1.4** | `Specs/FatTail-Labs-Options-Lab-Surface-T-Ortho-Spec-v0.1.md` — **OL-TO** · DRAFT · S×t IV contour · What-if cursor not rewritten path (**TO-B1**) · Surface = Analyzer-canvas alternate; T Ortho = Easter Egg (**DL-509**) · **DL-476** · **DL-478** |
