...
| Spec **Analyzer Algo Alert v2.0 DRAFT** | `Specs/FatTail-Labs-Options-Lab-Analyzer-Algo-Alert-Spec-v2.0.md` — **AZ-ALGO** · Arming / In trade / Managing · advisory guide (never an automatic exit) · GEX as management · dynamic trail proposed; legacy taper is fallback + teaching line · **DL-660** · seats `Specs/Arming and Trade Management Specification.md` · parent `Specs/FatTail 0DTE Strategy Specification.md` · v1.0.16 SUPERSEDED as law, kept as W1–W4 as-built · bench `docs/Options-Lab-Analyzer-Algo-Alert-Full-Agent-Bench-Plan-v1.0.md` **v1.0.3** · board `agents/p-az-algo/` · **not BUILD AUTHORITY** |
...
| Spec **Surface Autofit v0.1.9** | `Specs/FatTail-Labs-Options-Lab-Surface-Autofit-Spec-v0.1.md` — **ACCEPTED** · default pad **50%** · $0 plane **40%** · Autofit restores both (**DL-506** · **DL-507** · **DL-508**) · **DL-421** · bench `docs/Options-Lab-Surface-Autofit-Full-Agent-Bench-Plan-v1.0.md` · **DL-422** |
