...
| Spec **Position Builder/Book v0.1** | `Specs/FatTail-Labs-Options-Lab-Position-Builder-Spec-v0_1.md` — DRAFT review baseline (card=definition · viewport=OPF viz · lock); DL-295 |
