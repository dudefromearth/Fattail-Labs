...
| Spec **IKI Lab + Factory v0.1.3** | `Specs/FatTail-Labs-IKI-Lab-and-Factory-Spec-v0.1.md` — **IKI** · suite chrome/naming · Wiki Apps card → **IKI Lab** · **DL-527** · **DL-528** · **OD-IKI-1 CLOSED** by Factory Spec v0.1.5 **BUILD AUTHORITY** (**DL-556**) · **Runner URL admin-only + server redirect** to `/app/iki/about` (**DL-593** · Ernie lock 2026-08-28) |
