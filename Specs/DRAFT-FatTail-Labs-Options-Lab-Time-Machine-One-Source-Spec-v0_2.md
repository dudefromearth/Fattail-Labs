# FatTail Labs — Options Lab Time Machine One Source Spec v0.2
...
**Filename:** `DRAFT-FatTail-Labs-Options-Lab-Time-Machine-One-Source-Spec-v0_2.md`
...
| **TMI-88** SNAPSHOT, NOT APPEND (§0.4) | **The hold is a snapshot of what StudioOne held at the moment the playhead was raised.** It does not append, does not chase the newest edge, and is not topped up while scrubbing. A member who wants a newer range **raises the scrubber again** — disconnect, reconnect. Today and a past date behave identically in this respect, which is the point of one source.
...
**Next:** Coach stamp or return. TMI-88 and decay are ruled; the open question is now empirical — what a full dense day costs resident (AT-TM-C11).
