...
Full index of E1–E14 in **Appendix C**.
...
| `LABS_LIM_XPROX_FLOOR_PCT` / `_CEIL_PCT` | 0.5 / 1.5 | LIM16 (E2 · E10) |
...
**Which parent is live is not settled in this document (OD-LIM9).** This spec's header cites
`Options-Lab-Heatmap-Templates-Spec-v0_3`; `Options-Lab-Heatmap-Templates-Spec-v0_2_1` also exists
in `Specs/`. India confirms the live parent **before** the merged amendment draft is opened. An
amendment written against a superseded parent is a silent fork of the registry contract.
...
| **OD-LIM9** | **Live parent:** Heatmap Templates v0.2.1 or v0.3. Blocks §15.6 | **India** |
...
| **v0.4.2** | **2026-09-02** | **Second errata pass E8–E14, geometry unchanged.** Y clamp and `yUnclamped` removed as dead by construction · floors to 0/100 · canonical key appendix · Compact keeps the ring · IKI gate acknowledged · trail resets on expiration and symbol · registry ships one mode. Appendices A/B/C added. **No law created.** |

---

## 18. Prior claim withdrawn

v0.4.1 §2 asserted *"DL-539 does not gate this."* Withdrawn. The §8 five-module allowlist does not
