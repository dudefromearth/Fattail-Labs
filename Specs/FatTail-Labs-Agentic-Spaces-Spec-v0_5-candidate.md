...
**Version:** v0.5 --- candidate rewrite for Coach review\
**Parent doctrine:** v0.4 --- frozen\
**Status:** Advisor rewrite. Not stamped. No seeds, no gates.\
**Program:** Spaces\
...
The direct antecedent is JavaSpaces and Jini, and behind those Linda and
the blackboard architectures descending from Hearsay-II. Those systems
provided much of the environmental shape: shared things, decoupled
participants, associative access, and coordination through a common
medium.
...
Like the gate, privacy inherits at birth unless overridden and does not
silently mutate afterward.
...
Two good parents can produce different children. Descent explains where
a space came from; it does not govern what the space becomes.
