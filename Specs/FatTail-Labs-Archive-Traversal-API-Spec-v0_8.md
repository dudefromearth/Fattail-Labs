# FatTail Labs — Archive Traversal API Spec v0.8

**Status:** **DRAFT — not BUILD AUTHORITY.** Needs Coach, India (architecture boundary),
Sheldon (estimators: fill, stickiness), Foxtrot (lab host, format). Decision-log entry
required.
**Date:** 2026-09-05 · **Short name:** **ATRV** · **Owner:** Juliet (draft) → Alpha / Foxtrot
**Supersedes:** v0.7 (2026-09-05) — advisor review. Closes four places where this document
contradicted its own §3.10 or SSR-MEXP, adds the **era-1 fidelity state**, and stops pinning
analysis to a hostname.
...
| **OD-ATRV-6** | **Fill model** — the probability component, fitted from depth (§3.7) | **Sheldon** | **Blocking after-tax answers.** Until stamped, `unfitted_pessimistic` |
