# FatTail Labs — Collector Multi-Expiration Capture Spec v0.2
...
· Time Machine v0.7.4
**Supersedes:** v0.1 (2026-09-05) — same engineering, wrong frame. v0.1 read as a list of
things that break. This is step two of what the collector was always for.
