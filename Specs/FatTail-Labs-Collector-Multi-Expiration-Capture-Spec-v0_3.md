# FatTail Labs — Collector Multi-Expiration Capture Spec v0.3
...
· Time Machine v0.7.4
**Supersedes:** v0.2 (2026-09-05) — adds §1.8, the capability Coach named last: every
strategy, any start, any end. v0.1 had the right engineering and the wrong frame.
