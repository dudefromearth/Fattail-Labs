# FatTail Labs — Collector Multi-Expiration Capture Spec v0.5
...
· Time Machine v0.7.4
**Supersedes:** v0.4 (2026-09-05) — adds §1.10, the full greek set per strike, and the
consequence nobody had named: **AZ-ALGO §14 can run on the archive that already exists.**
