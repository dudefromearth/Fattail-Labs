# FatTail Labs — Collector Multi-Expiration Capture Spec v0.6
...
· Time Machine v0.7.4
**Supersedes:** v0.5 (2026-09-05) — adds **§3.1, the capture policy that governs this whole
document**: store the vendor payload **verbatim**. Reduce on read, never on write. v0.2–v0.5
enumerated fields one at a time, which is the wrong shape of answer and how `bid_size` came
to be discarded.
