# FatTail Labs — Collector Multi-Expiration Capture Spec v0.7
...
· Time Machine v0.7.4
**Supersedes:** v0.6 (2026-09-05) — adds **§4.1, the follow algorithm**. §3.1 is verbatim on
**fields**; strikes are **bounded** by a volatility band that *leads* price rather than
reacting to it. Two different axes, stated together so they cannot be read as one rule.
