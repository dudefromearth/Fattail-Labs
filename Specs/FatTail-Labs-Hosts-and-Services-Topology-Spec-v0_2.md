...
| **OD-HOST-7** | ~~Order of the two recommissions~~ **Disposed by Coach 2026-09-07: DudeOne first** — *"get DudeOne recommissioned and identical to MiniTwo, and set to switch over later this afternoon or tomorrow"*. Runbook: `docs/ops/DudeOne-Recommission-Runbook.md` (D0–D5); "identical" = same `infra/scripts/host-fingerprint.sh` output | Coach | — |
| **OD-HOST-2** (amended) | ~~weekend of 9/12~~ **Disposed by Coach 2026-09-07:** the switch (D5/H4) happens **only with Conor online during the procedure** — afternoon of 9/7 or 9/8 at the earliest; no hurry | Coach · Conor | not before Conor is on the call |
