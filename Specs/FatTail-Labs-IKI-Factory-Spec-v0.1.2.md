# FatTail Labs — IKI Factory Spec v0.1.2
...
| Ver | Date | Notes |
|-----|------|-------|
| **v0.1.2** | 2026-08-23 | Coach ruling (Lima DL): WooCommerce is the commerce entry point platform-wide. OD-F6 generalized. Native-Billing-Stripe remains superseded-unless-Coach-revives. Commerce law added to header, §2, §6, §7, §9, and closed decisions. No product code changes required by the ruling itself. |
...
**End of IKI Factory Spec v0.1.2 (DRAFT)**
