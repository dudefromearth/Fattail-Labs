...
> (Wiki Spec v0.2.1 APPROVED). Duplicate path of `…-v0.1.md`. Banner-only; body frozen.
...
| Visibility | Published wiki contents are wide open by default. No public read UI in v0.1 as-built (WA-6). Drafts never public. |
