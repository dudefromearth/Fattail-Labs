# FatTail Labs — Options Lab — Create / Edit Position Dialog — Spec v0.8
...
**Status:** **APPROVED — BUILD AUTHORITY.** Landed `Specs/` 2026-09-12 on Coach's stamp. DLG2 rebuilds against v0.8.
...
| **DLG-LAYOUT-3** | **Direction row** — directly beneath the strategy field, one unlabelled row carrying the **payoff icon** and the **Buy / Sell segmented control**. **That is all it carries.** No derived-name text, no Call / Put control. *(Coach, 2026-09-12.)* |
