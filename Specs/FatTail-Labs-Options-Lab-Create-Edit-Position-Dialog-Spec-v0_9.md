# FatTail Labs — Options Lab — Create / Edit Position Dialog — Spec v0.9
...
**Status:** **CANDIDATE — second markup applied: fields, header band, control elevation, action sizing.**
