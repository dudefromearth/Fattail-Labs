# FatTail Labs — Options Lab Position Control Spec v1.1
...
**Supersedes v1.0** (`Specs/FatTail-Labs-Options-Lab-Position-Control-Spec-v1_0.md`,
sha1 `cde65d2e0cc9a3cfb738a7394fcfa129e545ed8b`). v1.0 remains on disk as the version Bench Plan
v1.1 was written against.
...
*Position Control v1.1. Contract. No implementation before Coach's GO.*
