# FatTail Labs — Options Lab Time Machine Spec v0.7.1

**Status:** DRAFT v0.7.1 — **the tell changes, the rulings do not.** Coach, 2026-08-27: **Time Machine has no glow.** The glow belongs to What-if exclusively. Time Machine speaks in marks — a **REPLAY watermark** on the canvas and the **counter-clockwise badge** on rehearsal cards, the same mark at two scales. All six blocking opens remain ruled. **Phase 5 stamp candidate.**
**Type:** Product + technical spec — **Time Machine**
**Supersedes:** v0.7, v0.6.1,
**Routes:** `/app/options-lab/analyzer` · `/app/options-lab/heatmap` · `/app/options-lab/surface`
**Filename:** `FatTail-Labs-Options-Lab-Time-Machine-Spec-v0_7_1.md`
...
**All six blocking opens are ruled (§0.48–0.56). None remains.** What follows is the record of what was asked and how it was answered, plus the smaller opens that never blocked.
