# FatTail Labs — Wiki Agent Spec v0.1.2

> **SUPERSEDED (DL-555).** Spec of record is
> [`FatTail-Labs-Wiki-Spec-v0_2_1.md`](./FatTail-Labs-Wiki-Spec-v0_2_1.md).
> Prior pointer: Agent spec v0.1.3 (lineage). Body frozen. Banner-only.

**Status:** SUPERSEDED by Wiki Spec v0.2.1 (**DL-555**); previously superseded by
[`FatTail-Labs-Wiki-Agent-Spec-v0_1_3.md`](./FatTail-Labs-Wiki-Agent-Spec-v0_1_3.md)
(Coach rulings 2026-08-23 · **DL-551/552/553**). Kept as the WA-1…WA-3 as-built
contract. Do not implement from this file.
...
**Status (historical):** APPROVED (Coach 2026-08-23). Build authority was **GO WA-1**
only (**DL-548**). WA-2 and WA-3 subsequently stamped. Spec of record is **v0.1.3**.
...
it **seals immutable at close**. Sealed transcript = evidence; post-seal corrections
or follow-on direction arrive as a new session contract referencing the sealed one.
The WA-4 seed inherits this as settled.
