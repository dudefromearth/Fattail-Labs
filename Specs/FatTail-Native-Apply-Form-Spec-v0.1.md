...
**Date:** 2026-08-19  
**DL stub:** **DL-450** (spec filed; chair accept of the apply law + tag-18 plumbing — **not** BUILD)  
**Process:** Spec-first. **Not BUILD** until India **APPROVED** plus chair / Coach GO. No Juliet execution plan, seeds, or form code until that GO. This file is still **not** a build packet.
