...
**Series ID:** unassigned — spec intake assigns the next free ID in the `Specs/AZ-VP-9` series and records it in the decision-log entry
**Status:** DRAFT — pending Coach Phase-5 BUILD AUTHORITY
