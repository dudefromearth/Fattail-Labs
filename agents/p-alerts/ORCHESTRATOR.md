...
| C2-0 | Both viewport W-G PASS | **PASS** (Packet A W-G; return W-G Coach-overridden) |
| C2-BA | After C2-0 | **GO** |
| C2-1…C2-G | After C2-BA | **C2-G PASS** |
...
| Packet M | **PASS** |
| Packet C1 | **PASS** |
| Packet C2 | **C2-G PASS** (Coach finish-line after Packet A W-G + algo W4) |
