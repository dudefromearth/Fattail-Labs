...
**Agent:** Kilo  
**Depends:** P2-1 · P2-2  
**Law:** AT-GP1–11, 15a–c, 17, 19–21 · AT-GP20  

## Ask

Characterization in `server/tests/test_opf_generation_plane.py` (and keep `test_opf_foundation.py` green).

AT-GP1 must be **live** on the P1 host (Redis + a `mb:ladder:*` write → owned store, hydrator Massive counter = 0). A fixture does not close AT-GP1.
