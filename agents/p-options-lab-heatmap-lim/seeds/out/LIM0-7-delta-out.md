...
**Plan:** [`docs/Options-Lab-Heatmap-LIM-Full-Agent-Bench-Plan-v1.1.md`](../../docs/Options-Lab-Heatmap-LIM-Full-Agent-Bench-Plan-v1.1.md) §8–9  
...
| **LIM1-G** | `gate-reports/LIM1-G.md` | AT-LIM1–13, 16, 17, **17b**, 19, 20 (fields), 26, 28 on fixtures |
| **LIM2-G** | `gate-reports/LIM2-G.md` | AT-LIM13 (trail past edge), 14, 15, 25 |
| **LIM3-G** | `gate-reports/LIM3-G.md` | AT-LIM10, 18, 20 (chrome strings), 21, 22, 23 (chrome), 24, 27 |
| **LIM4-G** | `gate-reports/LIM4-G.md` | Glow / annotations / frozen GEX look. **No AT-LIM\* rows.** |
| **LIM5-G** | `gate-reports/LIM5-G.md` | Full pack AT-LIM1…28 **including 17b**. Missing row = **FAIL**. |
...
Hotel goldens (hand-recorded before `lim.ts`): **eight** fixtures — Spec §10 / plan §6.7. Three fixtures is **FAIL** at LIM1-G.
