...
**Project:** Quant Lab Fill-Friction (QFRIC) · **Agent:** Delta · **Phase:** P0 · **Feeds gate:** P1
...
## Verdict rule
PASS only if P0-1 files landed, P0-2 PASS, B1 resolved on the token, and `server/` + `web/` unchanged since `9a9cf1f`. Then Juliet writes P1 seeds; P1-1 may not start before this report exists.

## Report
`agents/p-quant-friction/gate-reports/P0-G.md`.
