...
**Open REQs:** REQ-001 OPEN · REQ-002 OPEN · REQ-003 OPEN (surface **HOLD** — PNG not on main).

| Gate | Packet | Seat | Machine | Status |
|------|--------|------|---------|--------|
| SYM0-G | Advisor pass v0.2.1 | India | StudioTwo | **NEXT** |
| SYM1-G | Registry API + SYM laws + PP-1 initial rows | Alpha + Kilo | StudioOne **CP-1** | pending SYM0-G |
| SYM2-G | Tagged fixture §5 | Alpha + Kilo | StudioTwo (file) | parallel after SYM0-G |
