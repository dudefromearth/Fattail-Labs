...
| **AZ-VP-9-A13** | [`Specs/amendments/AZ-VP-9-A13.md`](../../Specs/amendments/AZ-VP-9-A13.md) · **DL-744** · sha1 `292a711a94fd6d31cc18750da86f7f1fa3f35d15` · TV look parity · benchmark PNGs on the board |
...
| **Data Delivery v1.1** | [`Specs/VP-Data-Delivery-Spec-v1_1.md`](../../Specs/VP-Data-Delivery-Spec-v1_1.md) · **DL-761** sha1 `5955d88d36495846e7f28180738de7f4c38900ae` · D6 continuous B-ADJ · supersedes v1.0 row; v1.0 stays on disk |
| **Fidelity / Spread Lab (parked)** | **DL-762** · **FI-051** — per-contract SoR; 2a–2c named, not built; Spread/Stat-Arb Lab is a separate product when Coach commissions it |
