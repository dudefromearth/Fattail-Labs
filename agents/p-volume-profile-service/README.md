...
**Seated law:** VP Service **v0.6** (data end) · **DL-721/722**. SA **v0.3** detection baseline · **DL-721**. SA v0.4 file = **DIRECTIVE POINTER** (**DL-728**), not BUILD.
...
| SA spec v0.4 | [`Specs/Structural-Analysis-Service-Spec-v0_4.md`](../../Specs/Structural-Analysis-Service-Spec-v0_4.md) · **POINTER** · **DL-728** |
