...
**Rider (2026-09-20 · DL-790):** `:4011` overlay + `python -m symbology.load_specs` fold into the **futures** instance's commit/push/deploy GO. Weekend is the post-close window. Spec instance stands down from StudioOne. Seed: `agents/p-symbology-registry/seeds/REQ-009-FOLD-IN-4011.md`.
