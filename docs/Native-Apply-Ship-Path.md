...
**Decision:** **DL-451** · **DL-452** · **DL-455** · **DL-456** · **DL-457**  
...
| Form | `web/components/ApplyForm.tsx` | Conversation invite (**DL-453**). **Back left / OK right under the field** — visual twins (**DL-457**). Click / tap / Enter / Tab still accept. Two motion beats. Last live question goes to **Review** (**DL-455**). Edits are **in place on the list** (**DL-456**). POST `/api/apply` only from Review Accept. |
