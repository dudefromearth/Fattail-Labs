...
**Decision:** **DL-451** · **DL-452** · **DL-455** · **DL-456** · **DL-457** · **DL-458** · **DL-460** · **DL-461**  
...
| Form | `web/components/ApplyForm.tsx` | Conversation invite (**DL-453**). Field 7 is **one listed server slot** (**DL-461**); ICS on accept (**DL-460**). **Back left / OK right under the field** — visual twins (**DL-457**). Thick ink field border (**DL-458**). Click / tap / Enter / Tab still accept. Two motion beats. Last live question goes to **Review** (**DL-455**). Edits are **in place on the list** (**DL-456**). POST `/api/apply` only from Review Accept. |
...
| Admin | `/apply?edit=1` (primary) · `/admin/apply-slots` | In-place `EditableDatetime` / Edit bar. Same language as course sections. |
