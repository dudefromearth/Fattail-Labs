# Options Lab Heatmap — Value modes (member explainer)
...
Keep this file and the help reference in the same edit.

The text below is the member article.
...
Builder**, not on the Heatmap (**DL-444**).
