...
**Date:** 2026-09-13  
**Status:** **SUPERSEDED** by [`docs/Options-Lab-XSP-SPY-Scale-Full-Agent-Bench-Plan-v1.3.md`](./Options-Lab-XSP-SPY-Scale-Full-Agent-Bench-Plan-v1.3.md). Do **not** stamp or execute against this file.  
**Plan revision:** **v1.2**  
**Author:** Juliet (orchestration) / design-doc-writer  
**Authority:** Coach (GO / ship)  
**Canonical land path:** `docs/Options-Lab-XSP-SPY-Scale-Full-Agent-Bench-Plan-v1.2.md`  
**Parent:** v1.1 (2026-09-13). Advisor fold: **Amendment A** (Claude 2026-09-13) — both items make the packet **smaller**. Editorial §6/OD-XS9 contradiction closed.  
...
- [ ] Plan revision **v1.2** and whole-file sha1 — **not v1.0 or v1.1**  
...
**End of Options Lab XSP / SPY Scale Refactor Full Agent Bench Plan v1.2 (Draft)**
