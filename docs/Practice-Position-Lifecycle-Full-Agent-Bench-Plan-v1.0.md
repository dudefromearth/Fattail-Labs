# Practice Position Lifecycle — Full Agent Bench Plan v1.0

**Document type:** FatTail Labs Full Agent Bench Plan  
**Date:** 2026-09-14  
**Status:** **SUPERSEDED as execution snapshot** by [v1.1](./Practice-Position-Lifecycle-Full-Agent-Bench-Plan-v1.1.md). Kept on disk. Do not stamp this file.  
**Plan revision:** **v1.0** (superseded 2026-09-14)  
**Author:** Juliet (orchestration)  
**Authority:** Coach (GO / ship)  
**Canonical land path:** `docs/Practice-Position-Lifecycle-Full-Agent-Bench-Plan-v1.0.md`  
...
**W0 token:** [`agents/go/PPL0-W0.md`](../agents/go/PPL0-W0.md) — **AWAITING STAMP**
...
**PPL3-G:** AT-PPL-6/7 inverted · kit grep: no `window.confirm` on trade-log page or TradeSheet · Echo visual of AlertDialog · isolation FAIL list.
