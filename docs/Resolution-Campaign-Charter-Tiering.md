...
**Status:** Coach ruling 2026-08-09 — **folded into** [Campaign Phase Model v0.2](./Campaign-Phase-Model-v0_2.md)  
**Date:** 2026-08-09  
...
| **Max drawdown %** | Tolerated max DD for this campaign as **% of allocation only** (Coach 2026-08-09) | Ring 3 input — **with allocation, this makes solved size computable for every campaign**, not just the diligent ones |
...
## 5. Open words for Coach — **CLOSED 2026-08-09**

| # | Question | Coach lock |
|---|----------|------------|
| 1 | **End date** | **Not required** to start/sign. Still on the form. **Required to complete and archive** the campaign. |
| 2 | **Same-bet at Tier 2** | **Confirm.** Optional, but **actionable** for those who use it (not Tier 3). |
| 3 | **Max DD form** | Always **percent** (of allocation). Not dollars; no dual form. |
| 4 | Tier-3 promote/demote | Residual one-word overrides only. |

Recorded in Campaign Phase Model **v0.2.1** §8.
...
| 2026-08-09 | Folded into Campaign Phase Model v0.2 (Grok) |
| 2026-08-09 | Coach closes §5: end optional-but-needed-to-close; T2 optional/actionable; max DD always % |
