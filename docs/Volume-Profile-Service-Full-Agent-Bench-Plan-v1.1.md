# Volume Profile Service — Full Agent Bench Plan v1.1

**Document type:** FatTail Labs Full Agent Bench Plan  
**Date:** 2026-09-16  
**Status:** **SUPERSEDED as execution snapshot** by [v1.2](./Volume-Profile-Service-Full-Agent-Bench-Plan-v1.2.md). Kept on disk. Do not stamp this file.  
**Original status:** **Planning candidate — not a build GO.** Spec v0.5 (underscore restore) is DRAFT. **No product code until `VPS0-W0` is STAMPED.**  
**Plan revision:** **v1.1** (v1.0 SUPERSEDED as execution snapshot; kept on disk)  
**Author:** Juliet (orchestration)  
**Authority:** Coach (GO / ship)  
**Canonical land path:** `docs/Volume-Profile-Service-Full-Agent-Bench-Plan-v1.1.md`  
**Filename convention:** **dot** (`v1.1.md`). Specs: **underscore** `Specs/Volume-Profile-Service-Spec-v0_5.md`.  
**Supersedes:** [`docs/Volume-Profile-Service-Full-Agent-Bench-Plan-v1.0.md`](./Volume-Profile-Service-Full-Agent-Bench-Plan-v1.0.md)  
**Parent:** v1.0. **v1.1 freeze:** Claude review disposition (a)–(d) only. Spine not re-litigated.

**Machine:** Repo, board, and agent execution: **StudioTwo**. Deployment and runtime: **StudioOne** (spec §0). StudioOne is touched **only** by packets whose GO names it (first will be Q2 verification). No first-time install or cutover during RTH. MiniTwo / DudeTwo are **not this tree**. Never `git add -A`. Do not stop StudioTwo `:3000` / `:4000`.
...
**First build token (later):** `agents/go/VPS1-W0.md` — **do not create until GATE 0 PASS and Coach stamp**

### Claude findings fold — required for v1.1
...
| Part four structural analysis | Parked |
| StudioOne | Only packets whose GO names it |
...
| **1.1** | 2026-09-16 | Claude (a)–(d): Q5 gate wording; VP-L1…L17; StudioTwo vs StudioOne MACHINE; AT-VPS-14 out of Stage A counts. Restore sha1s **DL-705**. Not GO. |
