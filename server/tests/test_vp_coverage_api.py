...
def test_contiguous_allows_saturday_hole():
    days = [date(2026, 9, 11), date(2026, 9, 14)]  # Fri + Mon, Sat-Sun
    # Sunday 13 is a session-calendar day (Globex); this pair is NOT contiguous
    assert is_contiguous(days) is False
