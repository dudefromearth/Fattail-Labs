...
// Presentation matches hub FAQ (accordion + elevated surfaces).
  ...
  return (
    <main className="mx-auto w-full max-w-3xl px-6 py-10">
      ...
      <p className="mt-2 max-w-xl text-[var(--color-label-secondary)]">
        Unlock every course, quiz, resource, and live session. First lesson of
        the doctrine either way: stop the bleeding.
      </p>
      <div className="mt-8">
        <Suspense>
          <MembershipPlans />
