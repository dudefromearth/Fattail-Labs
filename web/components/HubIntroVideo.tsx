  ...
  return (
    ...
    >
      ...
      <span className="absolute inset-0 flex items-center justify-center">
        <span className="flex h-16 w-16 items-center justify-center rounded-full bg-[#00B478] text-2xl text-white shadow-xl transition-transform group-hover:scale-110 sm:h-20 sm:w-20 sm:text-3xl">
          ▶
        </span>
      </span>
