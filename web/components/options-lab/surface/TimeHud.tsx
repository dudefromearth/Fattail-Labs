...
export default function TimeHud({
  ...
  return (
    <div
      className="pointer-events-auto absolute bottom-3 left-3 z-20 w-[min(22rem,calc(100%-6rem))] rounded-2xl border border-white/12 bg-black/55 p-3 text-white/80"
