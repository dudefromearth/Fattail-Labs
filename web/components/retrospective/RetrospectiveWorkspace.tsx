  ...
  return (
    <label htmlFor={id} className="block">
      ...
      <textarea
        ...
        className="mt-2 w-full resize-y rounded-[var(--radius-md)] border border-[var(--color-separator)] bg-[var(--color-surface)] px-3 py-3 text-base outline-none focus:ring-2 focus:ring-[var(--color-tint)] disabled:opacity-70"
        data-testid={testId}
      />
    </label>
  );
...
export default function RetrospectiveWorkspace({
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-base font-semibold text-[var(--color-label)]">
          From your journal
        </p>
        <CompileList
